 ...
 * submit it as a PR!
 */
public class OptimisticLockungTestCase extends BaseCoreFunctionalTestCase {

	private static final Logger log = LoggerFactory.getLogger(OptimisticLockungTestCase.class);
